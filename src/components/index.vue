<template>
  <div>
    <v-toolbar class="mx-auto" dark elevation="0" color="blue">
          ...
          <template v-for="(video, i) in videosData">
            ...
            <v-list-item :key="'j' + i">
              <template v-slot:default="{ active }">
                <v-list-item-avatar size="150" rounded="0" @click="over(video)">
                  <v-img
                    :src="video.pictures.sizes[6].link_with_play_button"
                  ></v-img>
                </v-list-item-avatar>
                <v-list-item-content>
                  <v-list-item-title
                  ...
                  ></v-list-item-title>
                  <v-list-item-title
                    v-text="'URL: ' + video.uri"
                  ></v-list-item-title>
                  <v-list-item-title
                    v-text="'Duração do Video: ' + video.duration + ' segundos'"
                  ></v-list-item-title>
                  <v-overlay :value="overlay">
                    <v-card>
                      ...
                      <vimeo-player ref="player" :video-url="videolink" />
                    </v-card>
                  </v-overlay>
                </v-list-item-content>
                <v-list-item-action>
            ...
            <v-divider v-if="video < video.length - 1" :key="video"></v-divider>
          </template>
        </v-list-item-group>
      </v-list>
    </v-card>
